...
if ((isset($_POST['form'])) && ($_POST['form'] == 'tratdet')){
	...
	if($action=='INSD'){
		if((isset($_POST['tipTD']) ? $_POST['tipTD'] : NULL)=='I'){
			$indicacion=(isset($_POST['descripcion']) ? $_POST['descripcion'] : NULL);
		}
		...
		SSQL((isset($_POST['idref']) ? $_POST['idref'] : NULL), "int"),
		SSQL((isset($_POST['tipTD']) ? $_POST['tipTD'] : NULL), "text"),
		...
		SSQL((isset($_POST['cantidad']) ? $_POST['cantidad'] : NULL), "text"),
		SSQL((isset($_POST['numero']) ? $_POST['numero'] : NULL), "text"),
