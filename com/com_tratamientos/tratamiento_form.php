...
<nav class="navbar navbar-default" role="navigation">
	...
	<div class="navbar-right btn-group navbar-btn">
		...
		<?php echo $btnaction ?>
        <?php if($idt){ ?>
		<a href="<?php echo $RAIZc; ?>com_tratamientos/receta_print.php?idt=<?php echo $idt ?>" class="btn btn-info"><i class="fas fa-print fa-lg"></i> Imprimir</a>
        <?php } ?>
		</li>
	</div>
	</div><!-- /.navbar-collapse -->
...
<tr>
    ...
    <td><?php echo $dRStl['comercial'] ?></td>
...
<?php case 'I': ?>
<tr>
    <td colspan="6"><?php echo $dRStl['indicacion'] ?></td>
    <td>
    <a href="tratamiento_form.php?idt=<?php echo $idt ?>&idtd=<?php echo $dRStl['id'] ?>" class="btn btn-primary btn-xs">
    <i class="fas fa-edit fa-lg"></i> Editar</a>
    <a href="_fncts.php?idt=<?php echo $idt ?>&idtd=<?php echo $dRStl['id'] ?>&acc=<?php echo md5(DELtd) ?>&url=<?php echo $urlc ?>" class="btn btn-danger btn-xs">
