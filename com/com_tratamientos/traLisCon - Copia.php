  ...
  <div class="panel-body">
	...
	<tr class="<?php echo $css['tr'] ?>">
           ...
           <?php }while ($dRStli = mysql_fetch_assoc($RStli));?>
            ...
            <a href="<?php echo $RAIZc ?>com_tratamientos/tratamientoForm.php?idt=<?php echo $dRSt['tid'] ?>&acc=<?php echo md5(DELtf) ?>" class="btn btn-danger btn-xs fancyR" data-type="iframe">
