...
$query_RS_det_pag = sprintf("SELECT * FROM tbl_pagopac_cab INNER JOIN tbl_pagopac_det ON tbl_pagopac_cab.pag_num=tbl_pagopac_det.pag_num WHERE tbl_pagopac_cab.pag_num=%s", GetSQLValueString($id_pag, "int"));
