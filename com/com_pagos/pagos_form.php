...
$query_RS_cta_deuda = sprintf("SELECT db_pacientes.pac_cod,  (SELECT  SUM(tbl_cta_por_cobrar.cta_valor-tbl_cta_por_cobrar.cta_abono) FROM tbl_cta_por_cobrar WHERE tbl_cta_por_cobrar.pac_cod=db_pacientes.pac_cod) AS Deuda FROM db_pacientes WHERE db_pacientes.pac_cod=%s", GetSQLValueString($id_pac_sel_pen_RS_cta_deuda, "int"));
...
$query_RS_pag_realiz = sprintf("SELECT tbl_pagopac_cab.pag_num, tbl_pagopac_cab.pag_fech, tbl_pagopac_cab.pag_val, tbl_pagopac_cab.emp_cod, tbl_pagopac_cab.pag_tip FROM tbl_pagopac_cab WHERE tbl_pagopac_cab.pac_cod=%s", GetSQLValueString($id_pac_sel_RS_pag_realiz, "int"));
