...
<div>
        	...
        	<div class="panel panel-primary">
                ...
                <div class="form-group">
                	<label class="col-sm-3 control-label">Usuario</label>
                     <div class="col-sm-9">
                     <input type="text" name="user_username" value="<?php echo $detU['user_username'] ?>" class="form-control" placeholder="Nombre de usuario" required>
                     </div>
                </div>
                <div class="form-group">
                	<label class="col-sm-3 control-label">Contraseña</label>
                     <div class="col-sm-9">
                     <a href="changePass.php" class="btn btn-warning fancybox fancybox.iframe"><i class="fa fa-key"></i> Cambiar Contraseña</a>
                     </div>
                </div>
                ...
                <div class="form-group">
                	<label class="col-sm-3 control-label">Tema</label>
                   	<div class="col-sm-9">
                        <input list="themes" name="user_theme" value="<?php echo $detU['user_theme'] ?>" class="form-control">
                        <datalist id="themes">
    ...
    <button type="submit" class="btn btn-block btn-primary"><i class="fas fa-save fa-lg"></i> GUARDAR</button>
	</form>
	<?php }else{ ?>
