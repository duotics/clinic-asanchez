            	...
            	<div class="row">
            		<div class="col-sm-6">
            			...
            			<?php 
							...
							<? genSelect("diagSel[]",$RSd,$listCats,'form-control', '', 'chosDiag',NULL,TRUE,NULL,'- Seleccione Diagnóstico -');?>
							</div>
							<div class="form-group">
								<input type="text" class="form-control" name="diagD" placeholder="Otros Diagnósticos">
							</div>
							<div class="form-group">
								<button type="button" class="btn btn-info btn-xs">AGREGAR</button>
							</div>
						</fieldset>
            		</div>
            		<div class="col-sm-6">
