...
$tr_RSo=mysql_num_rows($RSo);
?>
<div class="panel panel-primary">
  <div class="panel-heading">
	<i class="fa fa-female fa-lg"></i> OBSTETRICIA
    <a href="<?php echo $RAIZc ?>com_hc/obstetrico_form.php?idp=<?php echo $id_pac ?>" class="btn btn-default btn-xs fancybox.iframe fancyreload"> <i class="fas fa-plus-square fa-lg"></i> NUEVO </a>
  ...
  <div class="panel-body">
    <?php if ($tr_RSo>0){
        ...
        <div>
			...
			GetSQLValueString($row_RSo['obs_id'],'int'));
                $RSol=mysql_query($qryol);
                $row_RSol=mysql_fetch_assoc($RSol);
                $tr_RSol=mysql_num_rows($RSol);
            ...
            <tr <?php echo $classtr?>>
                    ...
                    <?php }while ($row_RSol = mysql_fetch_assoc($RSol));?>
                    </tbody></table>
                ...
                <?php } while ($row_RSo = mysql_fetch_assoc($RSo));?>
                </tbody>
                </table>
            </div>
