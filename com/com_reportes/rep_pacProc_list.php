...
<div class="well well-sm">
  ...
  <a class="btn btn-info btn-sm fancybox fancybox.iframe" href="rep_pacProc_pdf.php?selr=1&FI=<?php echo $dFI ?>&FF=<?php echo $dFF ?>"><i class="fas fa-print fa-lg"></i> Imprimir Reporte</a>
  <a class="btn btn-info btn-sm fancybox fancybox.iframe" href="rep_pacProc_pdf.php?selr=2&FI=<?php echo $dFI ?>&FF=<?php echo $dFF ?>"><i class="fas fa-print fa-lg"></i> Imprimir Listado</a>
</div>
</div>
