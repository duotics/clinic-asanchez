...
<form method="post" action="_acc.php">
	...
	<div class="row well well-sm">
        ...
        <div class="form-group">
            ...
            <input name="hpeso" type="number" step="any" class="form-control input-sm" placeholder="Peso en Kg." value="<?php echo isset($dSig['peso'])?$dSig['peso']:'' ?>">
        </div>
        <div class="form-group">
        	<span class="help-block"><small>Talla en centimetros</small></span>
            <input name="htalla" type="number" step="any" class="form-control input-sm" placeholder="Talla en cm." value="<?php echo isset($dSig['talla'])?$dSig['talla']:'' ?>">
        </div>
        <div class="form-group">
        	<span class="help-block"><small>Índice de Masa Corporal</small></span>
            <input name="himc" type="number" step="any" class="form-control input-sm" placeholder="Indice de Masa Corporal" value="<?php echo isset($dSig['imc'])?$dSig['imc']:'' ?>">
        </div>
        <div class="form-group">
        	<span class="help-block"><small>Temperatura</small></span>
            <input name="htemp" type="text" class="form-control input-sm" placeholder="0,00" value="<?php echo isset($dSig['temp'])?$dSig['temp']:'' ?>">
        </div>
        <div class="form-group">
        	<span class="help-block"><small>Presión Arterial</small></span>
            <input name="hpa" type="text" class="form-control input-sm" placeholder="Presion Arterial" value="<?php echo isset($dSig['pa'])?$dSig['pa']:'' ?>">
        </div>
        <div class="form-group">
        	<span class="help-block"><small>Frecuencia Cardiaca</small></span>
            <input name="hfc" type="text" class="form-control input-sm" placeholder="0" value="<?php echo isset($dSig['fc'])?$dSig['fc']:'' ?>">
        </div>
        <div class="form-group">
        	<span class="help-block"><small>Frecuencia Respiratoria</small></span>
            <input name="hfr" type="text" class="form-control input-sm" placeholder="0" value="<?php echo isset($dSig['fr'])?$dSig['fr']:'' ?>">
        </div>
        <div class="form-group">
        	<span class="help-block"><small>Saturación de Oxigeno</small></span>
            <input name="hpo2" type="text" class="form-control input-sm" placeholder="0" value="<?php echo isset($dSig['po2'])?$dSig['po2']:'' ?>">
        </div>
        <div class="form-group">
        	<span class="help-block"><small>CO2</small></span>
            <input name="hco2" type="text" class="form-control input-sm" placeholder="0" value="<?php echo isset($dSig['co2'])?$dSig['co2']:'' ?>">
        </div>
        </fieldset>
        </div>
