...
<?php
	$contL.='<ul class="nav navbar-nav">
        ...
        <li><a>'.$dExa['fecha'].'</a></li>
    </ul>';
	echo genPageHeader($dM['mod_cod'],'navbar',null,null,null,null,null,$contL,$btnAcc.$btnAccJS.$btnNew) ?>
  ...
  <div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="tabA">
		<div class="row">
			...
			<?php
			$qryLTEF=sprintf('SELECT * FROM db_examenes_format_det WHERE idef=%s',
						  SSQL($idef,'int'));
			...
			<div class="col-sm-<?php echo $spanE[b] ?>">
				<div class="form-group">
					...
					<textarea name="iDes" class="form-control" id="iDes" placeholder="Detalle" style="height: 200px"><?php echo $dExa['des'] ?></textarea>
				</div>
				<!--
				<div class="form-group">
