...
if($detDiag){
	...
	$acc='UPDd';
	$vPF=TRUE;
	$btnAcc='<button type="button" id="vAcc" class="btn btn-success btn-large"><i class="fas fa-save fa-lg"></i> Actualizar</button>';
}else{
	$acc='INSd';
	$btnAcc='<button type="button" id="vAcc" class="btn btn-primary btn-large"><i class="fas fa-save fa-lg"></i> Grabar</button>';
}
...
if($TR>0){
	...
	$RSd = mysql_query($qry) or die(mysql_error());
