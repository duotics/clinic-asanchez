...
<div class="panel panel-primary">
  <div class="panel-heading">
	<i class="fas fa-file fa-lg"></i> HISTEROSCOPIAS 
...
<div>
	...
	<tr>
		...
		<a href="<?php echo $RAIZc; ?>com_docs/_acc.php?idd=<?php echo $det_id ?>&action=DELDF" class="btn btn-danger btn-xs fancybox fancybox.iframe">
