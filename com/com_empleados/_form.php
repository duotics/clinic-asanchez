...
if($detE){
	...
	$detU=detRow('db_user_system','emp_cod',$id);
}else{
	$acc=md5('INS');
        	...
        	<div class="panel panel-default">
                ...
                <div class="form-group">
                	<label class="col-sm-3 control-label">ID</label>
                     <div class="col-sm-9">
                     <input class="form-control" type="text" placeholder="nombre de usuario" value="<?php echo $detU['user_cod'] ?>" readonly>
                     </div>
                </div>
                <div class="form-group">
                	<label class="col-sm-3 control-label">Nombre Usuario</label>
                     <div class="col-sm-9">
                     <input class="form-control" type="text" placeholder="nombre de usuario" value="<?php echo $detU['user_username'] ?>" readonly>
                     </div>
                </div>
                <div class="form-group">
                	<label class="col-sm-3 control-label">Tema</label>
                     <div class="col-sm-9">
                     <input class="form-control" type="text" placeholder="tema visual para el usuario" value="<?php echo $detU['user_theme'] ?>" readonly>
                     </div>
                </div> 
                <div class="text-center">
                <a class="btn btn-info" href="<?php echo $RAIZc ?>com_usersystem/form.php?id=<?php echo $detU['user_cod'] ?>">
