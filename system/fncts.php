...
function gen_pageTit($MOD,$tit=NULL,$des=NULL,$icon=NULL){
	$banMod=FALSE;
	if($MOD){
...
function fnc_acces_usersys($param1){
	...
	$accessIp=getRealIP();
	$qryINS=sprintf('INSERT INTO db_user_access (user_cod, access_datet, access_ip) VALUES (%s, %s, %s)',
	GetSQLValueString($param1,'int'),
	GetSQLValueString($accessDate,'text'),
